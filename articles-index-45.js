(() => {
  const curated = [
    ...
    {slug:'yak-staty-shchaslyvym',cat:'Апатія',cat_slug:'apatiia',title:'Як стати щасливим',desc:'Чому щастя відкладається до наступної мети і які конкретні зміни варто перевіряти на собі.',time:10},
    ...
    {slug:'yak-navchytysia-radity-zhyttiu',cat:'Апатія',cat_slug:'apatiia',title:'Як навчитися радіти життю',desc:'Як повернути добровільні приємні дії та перевірити, що справді дає емоційний відгук.',time:10},
