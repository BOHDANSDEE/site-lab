(() => {
  ...
  const replacements = {
    ...
    'chomu-vazhko-pochaty-prostu-spravu': {
      ...
      desc: 'Чим ситуативне небажання діяти відрізняється від виснаження, цинізму щодо роботи та тривалого падіння ефективності.',
      time: 12
    },
    'yak-diiaty-koly-nemaie-motyvatsii': {
      slug: 'yak-diiaty-koly-nemaie-motyvatsii',
      title: 'Як діяти, коли немає мотивації',
      desc: 'Як не чекати правильного настрою, перевірити енергію, створити мінімальну дію та систему повернення після пропуску.',
      time: 12
    },
