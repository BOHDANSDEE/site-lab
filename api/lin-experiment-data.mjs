...
import { applyLinDepthOverride } from '../article-data/lin-depth-overrides.mjs';
export { LIN_GROUPS, LIN_SOURCES } from '../article-data/lin-experiment-common.mjs';

const BASE_LIN_ARTICLES = [...LIN_ARTICLES_1, ...LIN_ARTICLES_2, ...LIN_ARTICLES_3, ...LIN_ARTICLES_4];
export const LIN_ARTICLES = BASE_LIN_ARTICLES.map(applyLinDepthOverride);
